...
import club.mascotfan.temperature_api.db.SQLTemperateRepository
...
@Service
class MessageHandlerService(private val jsonMapper: JsonMapper, private val sqlTemperateRepository: SQLTemperateRepository) {
    ...
    fun handleTemperatureMessage(source: String, payload: String) {
        ...
        sqlTemperateRepository.recordTemperature(temperatureMessage)
    }
    fun handleHumidityMessage(source: String, payload: String) {
        ...
        sqlTemperateRepository.recordHumidity(humidityMessage)
    }
}